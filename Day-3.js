...
if(num > 0)
{
    ...
    console.log("Therefore ,Given Number is Zero ") //Output:Therefore, Given number is Positive
} 
...
if (age >= 18) {
    ...
    console.log("The person is not eligible to vote."); //Output:The person is eligible to vote.
}
...
if (a > b) {
    ...
    if (b > c) {
        ...
        console.log("The largest number is: " + c); //Output:The largest number is:7
    }                                                
}
...
switch (day) {
    ...
    default: console.log("Invalid day number.");  //Output:It's a Sunday
}
...
switch (true) {
    ...
    default: console.log("Grade: F");  //Output-Grade:A
}
...
let n = 2;
console.log(n % 2 === 0 ? "Even" : "Odd"); //Output:Even
...
if ((year % 4 === 0 && year % 100 !== 0) || (year % 400 === 0)) {
    console.log(year + " is a leap year.");
        ...
        console.log(year + " is not a leap year."); //Output:2028 is a leap year.
}
